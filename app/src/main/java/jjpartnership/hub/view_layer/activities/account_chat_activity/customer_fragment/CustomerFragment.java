...
public class CustomerFragment extends Fragment implements CustomerView{
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnCustomerChatFragmentInteractionListener) {
            mListener = (OnCustomerChatFragmentInteractionListener) context;
        } else {
    ...
    public void resetInputText() {
        mListener.resetUserInputCustomer();
    }
    ...
    public interface OnCustomerChatFragmentInteractionListener {
        void resetUserInputCustomer();
    }
}
