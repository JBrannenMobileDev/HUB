...
public class CustomerAccountDetailsPresenterImp implements AccountDetailsPresenter {
    ...
    public CustomerAccountDetailsPresenterImp(AccountDetailsView activity) {
